    ...
    <>
        <div className=' lg:pt-28 relative overflow-hidden'>
                <div className=' lg:w-446 lg:h-1197 bg-blue  lg:mb-0 px-7 lg:px-0'>
                        ...
                        <Image src="/assets/ilogo_lighting.png" width={1855} height={1471} alt="ilogo"/>
                        </div>
                    <div className=' lg:pt-20 pt-10  pb-7 '>
                        ...
                        <div className=" max-w-1085 lg:absolute lg:left-279">
                            ...
                            <button className=" font-bold md:text-base text-xs text-white md:py-5 py-3 md:px-12 px-6 bg-gradient-to-r from-blue to-purple hover:from-purple hover:to-blue transition duration-300 ease-in-out rounded-full mb-5 lg:mb-0 lg:absolute lg:right-16 lg:bottom-7 mt-7 lg:mt-0 ">
                            VIEW ALL
                        </button>
                        </div>
                    </div>
                                ...
                                <div className="relative lg:h-538 lg:w-660">
                                    <div className=" bg-img1 bg-cover bg-no-repeat bg-center h-407 relative">
                                            <div className=" absolute top-10 right-10">
                                                <Image src="/assets/ico_twitter.svg" width={42} height={34} alt="twitter"/>
                                            </div>
                                    </div>

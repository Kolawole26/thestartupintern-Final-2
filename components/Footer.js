    ...
    <>
        <div className=' lg:pr-72 relative lg:pb-24 overflow-hidden px-7 lg:px-0'>
            <div className=' bg-blue lg:pt-28  lg:pl-80 lg:pr-20 mt-7 px-7 lg:px-0 py-7'>
                ...
                <button className=" font-bold md:text-sm text-xs text-white md:py-5 py-3 md:px-12 px-6 bg-gradient-to-r from-yellow to-purple rounded-full mb-12 md:mb-24 ">
                    GOOGLE MAP
                </button>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div className="lg:flex items-center">
                                    <p className=" font-semibold md:text-xl text-base text-yellow relative -left-5">FOOTWARE</p>
